 ...
 * @toc-sort 1/2
*/
class org.jivesoftware.xiff.data.whiteboard.Stroke implements ISerializable
{
	...
	public function set color(c:Object):Void { myColor = Number(c.valueOf()); }
    ...
    public function set width(v:Number) { myWidth = v; }
    ...
    public function set opacity(v:Number) { myOpacity = v; }
}
