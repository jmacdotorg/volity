...
public class JoinMUCDialog extends BaseDialog implements ActionListener
{
    ...
    /**
     * Gets the MUC object that was created and joined.
     *
     * @return   The MUC that was created and joined when the user pressed the Join
     * button, or null if the user pressed Cancel or if there was an error.
     */
    public MUC getMUC()
    {
        return mMucObject;
    ...
    private void doJoin()
    {
        ...
        try
        {
            mMucObject = new MUC(mConnection, mMucIdField.getText());
