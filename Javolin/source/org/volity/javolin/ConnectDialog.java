...
{
	private final static String sNodeName = "ConnectDialog";
	...
	{
		super(owner, JavolinApp.getAppName() + ": Connect", true, sNodeName);
	...
	{
		Preferences prefs = Preferences.userNodeForPackage(getClass()).node(sNodeName);
