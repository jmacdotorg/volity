...
/**
   ...
   cc -c -dynamiclib -o source/org/volity/javolin/libMacGURL.ppc -I/System/Library/Frameworks/JavaVM.framework/Headers source/org/volity/javolin/MacGURLjnilib.c -arch ppc
   cc -c -dynamiclib -o source/org/volity/javolin/libMacGURL.i386 -I/System/Library/Frameworks/JavaVM.framework/Headers source/org/volity/javolin/MacGURLjnilib.c -arch i386
   cc -dynamiclib -o source/org/volity/javolin/libMacGURL.jnilib source/org/volity/javolin/libMacGURL.ppc -framework JavaVM -framework Carbon -arch ppc

   ...or build two thin JNI libraries and merge them with lipo to an Universal Binary
*/

#define OS_NATIVE(func)  Java_org_volity_javolin_GURLHandler_##func
